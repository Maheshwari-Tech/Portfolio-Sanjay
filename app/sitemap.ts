...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${siteConfig.url}/journey`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${siteConfig.url}/personal`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
